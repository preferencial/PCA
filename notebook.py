# -*- coding: utf-8 -*-
"""
Notebook padrao de analise grafica descritiva do projeto Preferencial - PCA.

Este arquivo gera distribuicoes, contagens e series temporais para inspeção
exploratoria. Ele não executa Análise de Componentes Principais, não produz
projeções ou combinações lineares de variância e não descobre fatores latentes;
relações observadas também não são interpretadas como causais.
