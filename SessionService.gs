...
// Renomeado de SESSION_TTL_SECONDS_sgteLegacy para evitar colisão de escopo global com a
// constante homônima declarada em 01_Auth_Login.gs (owner canônico da sessão PCA).
const SESSION_SVC_TTL_SECONDS = 21600;
